...
-- Todas populadas pelos efeitos cross-module conectados na Parte 2/3 (VehicleAvailabilityProjector
-- + Leitura de Hodômetro origem=ORDEM_SERVICO + ledger de impedimentos) — precisam sair antes do
-- veículo, mesma FK real.
DELETE FROM veiculo_impedimentos WHERE tenant_id = '05de0000-0000-0000-0000-000000000001';
