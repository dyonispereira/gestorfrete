...
Módulo de front-end responsável pela experiência de BI e dashboards analíticos, agregando dados de múltiplos módulos. Espelha o bounded context analytics do backend.
