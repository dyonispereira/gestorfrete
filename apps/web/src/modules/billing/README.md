...
Módulo de front-end responsável pela experiência de cobrança e faturas da assinatura da transportadora na plataforma GestorFrete (SaaS billing). Espelha o bounded context billing do backend.
