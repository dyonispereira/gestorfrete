...
import { useWorkOrderStatusHistoryQuery } from "@/modules/maintenance/hooks/use-work-order-status-history";
import { EmptyState } from "@/shared/components/states/empty-state";
import { ErrorState } from "@/shared/components/states/error-state";
import { LoadingState } from "@/shared/components/states/loading-state";

export function WorkOrderStatusHistory({ workOrderId }: { workOrderId: string }) {
  const historyQuery = useWorkOrderStatusHistoryQuery(workOrderId);
