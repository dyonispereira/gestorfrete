...
Módulo de front-end responsável pela experiência de configurações gerais da conta e preferências de usuário. Espelha o bounded context settings do backend.
