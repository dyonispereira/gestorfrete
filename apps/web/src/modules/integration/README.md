...
Módulo de front-end responsável pela experiência de configuração de integrações com sistemas externos. Espelha o bounded context integration do backend.
