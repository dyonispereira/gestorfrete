...
Módulo de front-end responsável pela experiência de gestão de relacionamento com clientes (leads, contatos, oportunidades). Espelha o bounded context crm do backend.
