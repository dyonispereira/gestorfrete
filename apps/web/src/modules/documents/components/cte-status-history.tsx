...
import { useCteStatusHistoryQuery } from "@/modules/documents/hooks/use-cte-status-history";
import { EmptyState } from "@/shared/components/states/empty-state";
import { ErrorState } from "@/shared/components/states/error-state";
import { LoadingState } from "@/shared/components/states/loading-state";

/** GET-only para sempre — mesmo padrão da Timeline de Viagem e do Hodômetro. */
export function CteStatusHistory({ cteId }: { cteId: string }) {
  const historyQuery = useCteStatusHistoryQuery(cteId);
