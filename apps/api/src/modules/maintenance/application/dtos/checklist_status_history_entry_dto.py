...
class ChecklistStatusHistoryEntryDTO:
    id: uuid.UUID
    status: str
    ...
    @staticmethod
    def from_entity(entity: ChecklistStatusHistoryEntry) -> "ChecklistStatusHistoryEntryDTO":
        return ChecklistStatusHistoryEntryDTO(
