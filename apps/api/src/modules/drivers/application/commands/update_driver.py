...
class UpdateDriverCommand(Command):
...
class UpdateDriverHandler(CommandHandler[UpdateDriverCommand, DriverDTO]):
    def __init__(self, audit_logger: AuditLogger | None = None) -> None:
        self._audit = audit_logger or AuditLogger()

    async def handle(self, command: UpdateDriverCommand) -> DriverDTO:
