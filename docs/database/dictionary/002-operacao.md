...
| VIAGEM.KM_RODADO | Km rodado | Decimal | Não | Derivado (rastreamento, `tracking`) | Não | Interno | Alimenta indicador de KPI, não persistido como fonte de verdade — ver `../../information-model/HIGH_VOLUME_ENTITIES.md` |
